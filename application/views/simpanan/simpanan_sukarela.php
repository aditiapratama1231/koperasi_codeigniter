                                ...
                                <div class="col-lg-12">
                                    <form role="form" method="post" action="<?php echo base_url('simpanan/aksi_simpan')?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="bulan" class="form-control" placeholder="Contoh : 2" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Tahun</label>
                                            <input type="text" name="tahun" class="form-control" placeholder="Contoh : 2017" required>
                                        </div>
                                        <div class="form-group">
